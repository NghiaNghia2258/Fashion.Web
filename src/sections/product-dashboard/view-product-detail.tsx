        ...
        >
          <Box>
            ...
            >
              ...
              >
                ...
                <TextField
                  ...
                  sx={{ width: '100%' }}
                  onChange={(event) => {
                    setProductGetById({ ...productGetById, name: event.target.value });
              ...
              >
                ...
                >
                  <Select
                    value={productGetById.categoryId}
                    onChange={(event: SelectChangeEvent) => {
                      setProductGetById({ ...productGetById, categoryId: event.target.value });
                    }}
                  >
            ...
            >
              ...
              <TextField
                value={productGetById.description}
                error={isErrInputDes}
